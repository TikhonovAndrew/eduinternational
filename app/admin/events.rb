ActiveAdmin.register Event do
  ...
  permit_params :branch_id, :name, :location, :description, :cover, :event_date_time, :event_date_time_end, :slug, :google_map_latitude, :google_map_longitude, :event_image, :event_image1, :subject
